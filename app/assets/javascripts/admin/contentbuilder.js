        ...
        this.render = function() {
            ...
            if (editMode == 'default') {
                ...
                $element.children('div.ui-draggable').each(function() {
                    try {
                        if (jQuery(this).children().first().children().first().parents("[data-mode='code']").length > 0) return;
            ...
            jQuery('#rte-toolbar *[data-rte-cmd="tags"]').unbind('click');
            jQuery('#rte-toolbar *[data-rte-cmd="tags"]').click(function(e) {
                $savedSel = saveSelection();
                jQuery('#md-tags-select').css('max-width', '120px');
                jQuery('#md-tags-select').simplemodal();
                jQuery('#md-tags-select').data('simplemodal').show();
                var s = '';
